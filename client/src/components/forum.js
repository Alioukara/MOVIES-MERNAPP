...
function Forum({ id }) {
  ...
  useEffect(
    () => {
      ...
      axios.get("https://weloveallmovies.herokuapp.com/conversations/allmessages").then(res => {
  ...
  useEffect(
    () => {
      ...
      socketRef.current = io.connect("https://weloveallmovies.herokuapp.com", { query: { id } })
